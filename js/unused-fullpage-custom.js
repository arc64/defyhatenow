...
(function($) {
   ...
   /* fullpage plugin config for index03.html */
   if ( $( "#fullpage" ).length ){
         $('#fullpage').fullpage({
            anchors: ['Home', 'Intro', 'Services', 'WorkProcess','Portfolio','About', 'Team', 'Blog','Testimonials','Contacts', 'ContactsForm', 'Subscribe'],
            navigation: false,
            ...
            afterLoad: function(anchorLink, index) {
               if (index == 9 && anchorLink=="Testimonials") {
                   slideTimeout = setInterval(function () {
                        $.fn.fullpage.moveSlideRight();
                    }, 5000);
               }
               // stop rolling on other slides
               if (index != 9) {
      ...
      /* testimonial on hover stop rolling */
   if ( $( "#fullpage" ).length ){
      $( ".each-testi" ).mouseenter(function() {
           clearInterval(slideTimeout);
      })
   }
   ...
   if ( $( "#fullpage" ).length ){
         $( ".each-testi" ).mouseleave(function() {
              slideTimeout = setInterval(function () {
                  $.fn.fullpage.moveSlideRight();
              }, 5000);
         })
   ...
   /* fullpage plugin config for multi-page index01.html */
   if ( $( "#fullpage-2" ).length ){
         $('#fullpage-2').fullpage({
            anchors: ['Home', 'Intro','About','Portfolio', 'Services', 'Team', 'Blog', 'SocialIcons','Contacts'],
            navigation: true,
   ...
   /* fullpage plugin config for index04.html */
   ...
   $(document).on('click',
      ...
      if ( $( "#fullpage" ).length ){
            /* this is used only if you're using index03.html with fullpage.js */
      ...
      setTimeout(
          function() 
          {
            if ( $( "#fullpage" ).length ){
               /* this is used only if you're using index03.html with fullpage.js */
               $('#section-portfolio .fp-controlArrow').fadeOut(500);
            }
   ...
   $(document).on('click', "#display-proj-1", function () {
         ...
         setTimeout(
          function() 
          {
            if ( $( "#fullpage" ).length ){
               /* this is used only if you're using index03.html with fullpage.js */
               $(".portfolio-project-name").fadeOut(500); 
            }
            $('#project-1').css('top', '0');
   ...
   $(document).on('click', "#close-proj-1, #close-proj-2, #close-more-aboutus, #close-bpost-1, #close-bpost-2", function () {
      ...
      setTimeout(
         ...
         {
            if ( $( "#fullpage" ).length ){
               $(".portfolio-project-name").delay(500).fadeIn(500);
               $('#section-portfolio .fp-controlArrow').delay(500).fadeIn(500);
   ...
   $(document).on('click', "#display-bpost-1", function () {
        ...
        setTimeout(
          function() 
          {
            ...
            if ( $( "#fullpage" ).length ){
               $('#section-blog .fp-controlArrow').fadeOut(500);
               $('.blog-title').fadeOut(200);
               $('.blog-meta').fadeOut(200);
            }
       ...
       setTimeout(
         function() 
         {
            if ( $( "#fullpage" ).length ){
               ...
               $('.blog-meta').fadeIn(500);
               $('#section-blog .fp-controlArrow').delay(500).fadeIn(500);
            }
   ...
   $(document).on('click', "#display-more-aboutus", function () {
        ...
        setTimeout(
          function() 
          {
            $('#section-moreabout .fp-controlArrow').fadeOut(500);
   ...
   $(document).on('click', "#close-more-aboutus", function () {
       ...
       setTimeout(
         function() 
         {
            ...
            $('#section-moreabout .fp-controlArrow').delay(500).fadeIn(500);
   ...
   /* next on project 1 - only on version that uses fullpage and big portfolio slides - index02.html */
   $(document).on('click', "#go-next-1", function() {
      if ( $( "#fullpage" ).length ){
         $("#project-1").scrollTo("#project-header-1", 1000);
         setTimeout(
           function() 
           {
             $("#close-proj-1").trigger("click");
             setTimeout(
               function() 
               {
                 $.fn.fullpage.moveSlideRight();
   ...
   /* prev on project 2 - only on version that uses fullpage and big portfolio slides - index02.html */
   $(document).on('click', "#go-prev-2", function() {
      if ( $( "#fullpage" ).length ){
         $("#project-2").scrollTo("#project-header-2", 1000);
         setTimeout(
           function() 
           {
             $("#close-proj-2").trigger("click");
             setTimeout(
               function() 
               {
